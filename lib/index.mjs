...
export default {
  ...
  configs: {
    recommended: {
      ...
      rules: {
        "ember-a11y-testing/a11y-audit-after-test-helper":
          rules["a11y-audit-after-test-helper"],
        "ember-a11y-testing/a11y-audit-no-expression":
          rules["a11y-audit-no-expression"],
        "ember-a11y-testing/a11y-audit-no-globals":
          rules["a11y-audit-no-globals"],
      },
    },
  },
};
